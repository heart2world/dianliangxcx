...
class MenuController extends AdminbaseController {
    ...
    public function index() {
        ...
        $result = $this->menu_model->order("listorder ASC")->select();
        $tree = new \Tree();
        $tree->icon = array('&nbsp;&nbsp;&nbsp;│ ', '&nbsp;&nbsp;&nbsp;├─ ', '&nbsp;&nbsp;&nbsp;└─ ');
        $tree->nbsp = '&nbsp;&nbsp;&nbsp;';
    ...
    public function delete() {
        ...
        $count = $this->menu_model->where("parentid='$id'")->count();
        if ($count > 0) {
    ...
    private function _export_app_menu_default_lang($app){
        $menus = $this->menu_model->where(array("app"=>$app))->order("listorder ASC,app ASC,model ASC,action ASC")->select();
